...
int64 nChainStartTime = 1525785662;
...
const string strMessageMagic = "BitGoldenCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	else if(nHeight > 200000 && nHeight <= 3900000)
    {
        nSubsidy = 5 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BitGoldenCoin
    bool fStrictPayToScriptHash = true; // Always active in BitGoldenCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitGoldenCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector Travelcoin empty mapBlockIndex Travelcoin Travelcoin";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xf6c903c6e58c2bd534f978e5c0a43b0fe0c15fe9bcb0fe2199ba3649d6d67a73"));
...
unsigned char pchMessageStart[4] = { 0xbc, 0x7b, 0x3e, 0xd3 };
